...
plotshape(iop_showlabels ? iop_pivothigh : na, title="Bearish OrderBlock", style=shape.triangledown, location=location.abovebar, color=color.new(color.red,   0), size=size.tiny, iop_offset=iop_po)
plotshape(iop_showlabels ? iop_pivotlow  : na, title="Bullish OrderBlock", style=shape.triangleup,   location=location.belowbar, color=color.new(color.green, 0), size=size.tiny, iop_offset=iop_po)
barcolor(iop_obc, iop_offset=iop_po)
