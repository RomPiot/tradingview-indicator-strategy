...
speedEmaTimeframe = input(1,"Période de l'EMA Rapide")
...
heikinAshi_close = security(heikinAshi_Ticker, timeframe.period, logTransform ? log(close[1]) : close[1], barmerge.gaps_off, barmerge.lookahead_on)
